...
def getPhone():
    ...
    for page in range(1,80):
        try:
            shop_url='https://www.lubanx.com/cod/jinritemai/goodsRank?p='+str(page)+'&s=50&keyword=&sortRule=0&firstCategory=10&secondCategory=0&thirdCategory=0&storeType=1&onShelf=0'
        ...
        print(page)
        print("执行保存")
        f.save('D:/鲁班-家居用品'+datetime.datetime.now().strftime('%Y%m%d')+'.xls')
